...
nombreNegocio = "Marco's Pizza"

'*PARAMETRO: DESTINATARIOS SEPARADOS POR ; (PUNTO Y COMA)
destinatario = "rvazquez@quintanapr.com"
...
objMessage.Subject = "Message sent through " + request.querystring("id") +":" + nombreNegocio
...
'*PARAMETRO: CONTRASE�A DE LA CUENTA QUE AUTENTICA
objMessage.Configuration.Fields.Item _
